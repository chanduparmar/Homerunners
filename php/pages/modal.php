<div id="modal1" class="modal" style=" overflow-x:hidden; overflow-y: hidden; ">
        <div class="row">
            <div class="col s4 login_bg" style="margin:none;padding-left: 0px; padding-right: 0px; "  >
                    <img src="images/modal.jpg" style="height:621px; width:330px ;margin-left:0px;  " >
            </div>
                <div class="col s8">
     ...
     <div id="modal3" class="modal" style=" overflow-x:hidden; overflow-y: hidden; color: black;">
            ...
            <div class="col s4 login_bg" style="margin:none;padding-left: 0px; padding-right: 0px; "  >
                ...
                <div class="col s8">
                    ...
                    <div class="row">
                            <div class="col s6 offset-s1">  
                                <button class="modal-action modal-close btn waves-effect waves-light  red hoverable editpass" id="<?php echo $_SESSION['email'];?>"type="submit" name="action">Submit
                                    <i class="material-icons right">send</i>
                                </button>
                            </div>
                            <div class="col s5">
